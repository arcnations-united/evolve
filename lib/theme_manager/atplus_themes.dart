            ...
            if (ID == 1) {
              themeMap.addAll({
                1: {
                  ...
                  "VERS": "N/A",
                  "DESC":
                      "Pastel inspired green colours. Calm and minimalist dark theme with muted colours."
                }
              });
            } else if (ID == 2) {
              themeMap.addAll({
                2: {
                  ...
                  "VERS": "N/A",
                  "DESC":
                      "Pastel inspired blue colours. Calm and minimalist dark theme with muted colours."
                },
              });
            } else if (ID == 3) {
              themeMap.addAll({
                3: {
                  ...
                  "VERS": "N/A",
                  "DESC":
                      "Pastel inspired purple colours. Calm and minimalist dark theme with muted colours."
                },
              });
            } else if (ID == 4) {
              themeMap.addAll({
