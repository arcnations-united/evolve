      ...
      child: AnimatedSlide(
        ...
        child: Stack(
         // mainAxisAlignment: MainAxisAlignment.center,
          children: [
            AnimatedPositioned(
              duration: ThemeDt.d,
              curve: ThemeDt.c,
              top: MediaQuery.sizeOf(context).height/2-(superLarge?150:240),
              left: (MediaQuery.sizeOf(context).width-(smallScreen?150:superLarge?600:350))/2,
              child:  Stack(
              children: [
              AnimatedSlide(
                duration: Duration.zero,
                offset: const Offset(-0.14,-0.13),
                child: ImageFiltered(
         ...
         AnimatedPositioned(
           duration: ThemeDt.d,
           curve: ThemeDt.c,
           top: MediaQuery.sizeOf(context).height/2-(superLarge?140:80),
           left: (MediaQuery.sizeOf(context).width-(smallScreen?136:superLarge?270:333))/2,
        ...
        AnimatedPositioned(
            duration: ThemeDt.d,
            curve: ThemeDt.c,
            top: MediaQuery.sizeOf(context).height/2-(superLarge?97:30),
            left: (MediaQuery.sizeOf(context).width-(smallScreen?230:superLarge?270:430))/2, child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                GestureDetector(
                  onTap: ()async{
                    ...
                    child: WidsManager().getTooltip(
                      ...
                      child: WidsManager().getContainer(
                        child: WidsManager().getText("vers : ${AppData.vers.toString()}${superLarge?"-${AppData.release}":""}"),
                      ),
                    ),
                  ).animate(
                    effects: [
                  ...
                  if(!superLarge) const SizedBox(
                    width: 8,
                  ),
                  if(!superLarge)   WidsManager().getContainer(
        ...
        AnimatedPositioned(
          duration: ThemeDt.d,
          curve: ThemeDt.c,
          top: MediaQuery.sizeOf(context).height/2+(superLarge?-50:35),
          left: (MediaQuery.sizeOf(context).width-(!TabManager.isLargeScreen?210:smallScreen?370:superLarge?260:580))/2, child:
                 Container(
                   width: superLarge||!TabManager.isLargeScreen?200:MediaQuery.sizeOf(context).width,
                   child: WidsManager().getText(
          ...
          AnimatedPositioned(
              duration: ThemeDt.d,
              curve: ThemeDt.c,
              top: MediaQuery.sizeOf(context).height/2+(superLarge?20:59),
              left: (MediaQuery.sizeOf(context).width-(smallScreen?420:600))/2,
